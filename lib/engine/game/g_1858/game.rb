      ...
      class Game < Game::Base
        ...
        TILES = {
          ...
          'A1' => {
            'count' => 1,
            'color' => 'yellow',
            'code' => 'city=revenue:40;path=a:0,b:_0;path=a:1,b:_0;label=B',
          },
          'A2' => {
            'count' => 1,
            'color' => 'yellow',
            'code' => 'city=revenue:40;path=a:0,b:_0;path=a:2,b:_0;label=B',
          },
          'A3' => {
            'count' => 1,
            'color' => 'yellow',
            'code' => 'city=revenue:40;path=a:0,b:_0;path=a:_0,b:3;label=B',
          },
          ...
          'A6' => {
            'count' => 1,
            'color' => 'green',
            'code' => 'town=revenue:10;path=a:0,b:_0,track:narrow;path=a:2,b:_0,track:narrow;path=a:3,b:_0,track:narrow;path=a:4,b:_0,track:narrow',
          },
          'A7' => {
            'count' => 1,
            'color' => 'green',
            'code' => 'city=revenue:50;city=revenue:50;city=revenue:50;' \
          ...
          'A8' => {
            ...
            'code' => 'city=revenue:50,slots:2;' \
                      'path=a:0,b:_0;path=a:1,b:_0;path=a:2,b:_0;path=a:3,b:_0;label=B',
          },
          ...
          '108' => {
            'count' => 2,
            'color' => 'brown',
            'code' => 'junction;path=a:0,b:_0,track:dual;path=a:1,b:_0,track:dual;path=a:2,b:_0,track:dual;path=a:3,b:_0,track:dual',
          },
          '673' => 4,
          'A9' => {
            'count' => 4,
          ...
          'A12' => {
            'count' => 2,
            'color' => 'brown',
            'code' => 'city=revenue:50,slots:2;path=a:0,b:_0,track:dual;path=a:1,b:_0,track:dual;path=a:2,b:_0,track:dual;path=a:3,b:_0,track:dual;path=a:4,b:_0,track:dual;path=a:5,b:_0,track:dual;label=Y',
          ...
          'A14' => {
            'count' => 2,
            'color' => 'brown',
            'code' => 'city=revenue:40,slots:2;path=a:0,b:_0,track:dual;path=a:3,b:_0,track:dual;path=a:4,b:_0,track:dual;label=L',
          ...
          'A16' => {
            'count' => 1,
            'color' => 'brown',
            'code' => 'city=revenue:50,slots:2;path=a:0,b:_0,track:dual;path=a:3,b:_0,track:dual;path=a:4,b:_0,track:dual;path=a:5,b:_0,track:dual;label=P',

          },
          'A17' => {
            'count' => 1,
            'color' => 'brown',
            'code' => 'city=revenue:60,slots:2;path=a:0,b:_0,track:dual;path=a:3,b:_0,track:dual;path=a:4,b:_0,track:dual;path=a:5,b:_0,track:dual;label=B',
          ...
          'A18' => {
            'count' => 1,
            'color' => 'gray',
            'code' => 'city=revenue:60,slots:2;path=a:0,b:_0,track:dual;path=a:3,b:_0,track:dual;path=a:4,b:_0,track:dual;label=L',
          ...
          'A20' => {
            'count' => 1,
            'color' => 'gray',
            'code' => 'city=revenue:80,slots:2;path=a:0,b:_0,track:dual;path=a:3,b:_0,track:dual;path=a:4,b:_0,track:dual;path=a:5,b:_0,track:dual;label=B',
