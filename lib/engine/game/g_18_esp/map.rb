      ...
      module Map
        ...
        HEXES = {
          ...
          white: {
            ...
            %w[D5 D9 F9 F11 H9 I6 J7 D23 H21 E32 F31 I30 J23] => 'icon=image:18_usa/mine,sticky:1',
            %w[E8 F7] => 'city=revenue:0;icon=image:18_usa/mine,sticky:1',
            ...
            %w[C30 G30 G32 J21] => 'town=revenue:0;icon=image:18_usa/mine,sticky:1',
          ...
          orange: {
            ['E12'] => 'city=revenue:0;path=a:3,b:_0,track:dual;path=a:0,b:_0,track:dual;label=160',
            ['I12'] => 'city=revenue:0;path=a:3,b:_0,track:dual;path=a:1,b:_0,track:dual;label=100',
            ['K10'] => 'city=revenue:0;path=a:3,b:_0,track:dual;path=a:0,b:_0,track:dual;label=120',
            ['M8'] => 'city=revenue:0;path=a:2,b:_0,track:dual;path=a:0,b:_0,track:dual;label=120',
